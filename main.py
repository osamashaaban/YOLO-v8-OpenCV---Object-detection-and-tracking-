...
cap=cv2.VideoCapture('Entering Exiting count.mp4')
...
result = cv2.VideoWriter('output.avi', cv2.VideoWriter_fourcc(*'MJPG'),10, (1020,500))
...
#    frame=cv2.flip(frame,1)
    ...
    for bbox in bbox_id:
        x3,y3,x4,y4,id = bbox
        # People entering 
        # Using pointPolygonTest to check if the bottom right point inside the region of interest or not
